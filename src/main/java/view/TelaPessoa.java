...
public class TelaPessoa extends javax.swing.JFrame {
        ...
        initComponents();
          cmbVinculoPessoa.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                carregarPessoasCadastradas(); // Atualiza a lista de pessoas de acordo com o filtro
            }
        });
    ...
    public void changedUpdate(DocumentEvent e) {
        // Este método não é chamado em campos de texto normais
    }
});
    ...
    telaCadastro.preFillVinculo(vinculoSelecionado);  // Passando o vínculo selecionado
    telaCadastro.setVisible(true);
    
    carregarPessoasCadastradas(); // Recarregar as pessoas após cadastro
...
public void carregarPessoasCadastradas() {
    ...
    String nomeFiltro = txtBuscaNome.getText().trim();
    VinculoPessoa vinculoFiltro = (VinculoPessoa) cmbVinculoPessoa.getSelectedItem();
    
    List<Pessoa> pessoas = jpa.getPessoas(nomeFiltro, vinculoFiltro);
...
public void carregarVinculos() {
    // Adiciona os valores do enum VinculoPessoa no ComboBox
