...
public class TelaCadastroPessoa extends javax.swing.JDialog {
    ...
    PersistenciaJPA jpa;
    private TelaPessoa telaPrincipal;
    /**
     * Creates new form TelaCadastroPessoa
     */
    public TelaCadastroPessoa(TelaPessoa telaPrincipal, boolean modal) {
            initComponents();
...
public static void main(String args[]) {
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
        public void run() {
            // Aqui você deve passar uma instância de TelaPessoa, não um JFrame
            TelaPessoa telaPrincipal = new TelaPessoa();  // Criação da tela principal
            TelaCadastroPessoa dialog = new TelaCadastroPessoa(telaPrincipal, true);  // Passando a tela principal para o construtor
 ...
 public void preFillVinculo(VinculoPessoa vinculo) {
        cmbVinculoPessoa.setSelectedItem(vinculo);
    }
...
private void carregarVinculos() {
        for (VinculoPessoa vinculo : VinculoPessoa.values()) {
            cmbVinculoPessoa.addItem(vinculo);
        }
    }
}
